...
<xsl:stylesheet version="1.0"
    ...
    <script src="{$workspace}/components/sass-bootstrap/js/bootstrap-dropdown.js"></script>
    <script src="{$workspace}/components/sass-bootstrap/js/bootstrap-tooltip.js"></script>
    <script src="{$workspace}/components/sass-bootstrap/js/bootstrap-modal.js"></script>
    <script src="{$workspace}/components/sass-bootstrap/js/bootstrap-transition.js"></script>
    <script src="{$workspace}/components/sass-bootstrap/js/bootstrap-button.js"></script>
    <script src="{$workspace}/components/sass-bootstrap/js/bootstrap-popover.js"></script>
